<%@ Page Title="" Language="C#" MasterPageFile="~/department/admin/admin.master" AutoEventWireup="true" CodeFile="view.aspx.cs" Inherits="task_schedule_view" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">Schedule View</h3>
             <div class="float-left">
               ...
               <%--  <button id="button1" onclick="javascript:xport.toXLS('testTable');">Export</button>--%>
                    </div>
        </div>
        <div class="block-content">
         ...
         <%--  <table id="testTable" summary="Code page support in different versions of MS Windows." rules="groups" frame="hsides" border="2" class="table table-striped">
                ...
                <asp:GridView ID="grdexp" runat="server" Visible="false" CssClass="table-responsive" >
