<%@ Page Title="" Language="C#" MasterPageFile="~/department/admin/admin.master" AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="task_jobthrough_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <div class="js-wizard-simple block ml-30 mr-30 mt-15">
        <div class="block-header block-header-default">
                <h3 class="block-title">Add Job Through</h3>
        </div>
         <!-- Form -->
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             <div class="form-material floating">
                                 <asp:textbox id="txtjobthrough"  class="form-control cap" runat="server" name="wizard-simple2-firstname"></asp:textbox>
                                 <label for="wizard-simple2-firstname">Job Through Name</label>
                             </div>
                         </div>
                     </div>
    ...
    <div class="js-wizard-simple block ml-30 mr-30 mt-15">
        <div class="block-header block-header-default">
                <h3 class="block-title">All Job Through</h3>
        </div>
