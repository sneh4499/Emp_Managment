...
public partial class department_admin_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //string frmfeatch = expel.getSingleData("select fromdate from schedule where status like 'Pending'");
        //string frm = Convert.ToDateTime(frmfeatch).ToString("dd-MM-yyyy");

        //string tofeatch = expel.getSingleData("select todate from schedule where status like 'Pending' ");

        //string to = Convert.ToDateTime(tofeatch).ToString("dd-MM-yyyy");
